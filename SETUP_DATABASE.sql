-- Jalankan query ini di MySQL database pewaca_dev untuk membuat semua table
...
INSERT INTO `financial_summary` (`id`, `total_cost`, `total_income`, `revenue`, `resource_cost`, `opex_cost`, `capex_cost`, `profit`, `profit_margin`, `period`) VALUES
(UUID(), 1695000000.00, 3600000000.00, 3600000000.00, 1212000000.00, 420000000.00, 195000000.00, 1905000000.00, 52.92, '2025');

-- Sample Cashflow Projections
INSERT INTO `cashflow_projections` (`id`, `year`, `revenue`, `cost`, `net_cashflow`, `cumulative_cash`, `base_revenue`, `base_cost`, `revenue_growth`, `cost_growth`) VALUES
